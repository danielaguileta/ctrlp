          ...
          <div class="card-body">
            <div class="row">
                <div class="col-12 text-right">
                    <a href="#" class="btn btn-sm btn btn-social btn-fill btn-facebook">Registrar compra</a>
                </div>
                <br>
                <br>
            </div>
            <div class="table-responsive">
              <table id="tabla_compras" class="table table-hover text-nowrap" style="width:100%">
